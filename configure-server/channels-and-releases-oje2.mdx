...
You can find the latest beta image on [Docker Hub](https://hub.docker.com/r/prismagraphql/prisma/tags/) or simply use the `beta` tag when using the Docker CLI:

```bash
docker pull prismagraphql/prisma:beta
```
...
You can find the latest beta image on [Docker Hub](https://hub.docker.com/r/prismagraphql/prisma/tags/) or simply use the `alpha` tag when using the Docker CLI:

```bash
docker pull prismagraphql/prisma:alpha
```