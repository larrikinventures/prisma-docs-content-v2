...
Duye to legacy reasons, the Management API currently uses outdated terminology to describe Prisma concepts. Most notably, **Prisma services** are called **projects** (e.g. `listProjects`) and **Prisma servers** are called **clusters**.
