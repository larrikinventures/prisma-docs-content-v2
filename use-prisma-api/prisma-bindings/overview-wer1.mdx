...
The functions exposed by a Prisma binding are named after the _root fields_ of the Prisma database schema (which defines your Prisma API). Each function call constructs and sends the respective query/mutation to the Prisma API.
...
- `typeDefs`: The path to the Prisma database schema
