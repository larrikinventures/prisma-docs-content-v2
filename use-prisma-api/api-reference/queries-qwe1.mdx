...
If you want to learn about the concrete capabilities of your Prisma API, the easiest way is to explore the auto-generated API documentation inside a GraphQL Playground. You can do so by clicking the green **SCHEMA**-button at the right edge of the Playground:
