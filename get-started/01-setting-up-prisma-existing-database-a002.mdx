export const meta = {
  ...
  step: 1,
  gettingStartedTitle: 'Using Docker & an existing database',
  position: 3
}
...
## Step 3: Set up database and Prisma server
...
## Step 4: Create a Prisma service
...
## Step 5: Start local Prisma server
...
## Step 6: Deploy the Prisma service
...
## Step 7: Explore the Prisma API in a Playground
