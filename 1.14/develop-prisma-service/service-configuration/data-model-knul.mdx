...
The relations that are included in your schema affect the available operations in the [Prisma API](/1.14/use-prisma-api). Here is an overview of the generated CRUD and realtime operations for every relation in your Prisma API: 
