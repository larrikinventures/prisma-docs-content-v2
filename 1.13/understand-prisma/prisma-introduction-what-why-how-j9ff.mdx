...
When building a GraphQL server that uses Prisma as its data access layer, it is important to understand that the auto-generated Prisma GraphQL API is _not_ consumed by your client applications - instead you build the actual _application server_ on top of Prisma.
