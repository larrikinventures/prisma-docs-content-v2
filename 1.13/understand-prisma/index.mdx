import { Overview, OverviewLink } from 'components/Markdown/Overview'
...
<Overview title="Service Configuration">
  <OverviewLink
    title="Prisma Introduction: What, Why & How"
    href="#"
    description="Learn about Prisma's main features, use cases and how it fits into your architecture." />
  <OverviewLink
    title="Prisma Basics: Server, Services & Data Model"
    href="#"
    description="Learn about the concepts you'll be working with on a daily basis when using Prisma." />
  <OverviewLink
    title="Introduction to GraphQL Server Development"
    href="#"
    description="Learn how GraphQL servers are built. (Only relevant if you have no experience with building GraphQL servers)." />
  <OverviewLink
    title="Building GraphQL Servers with Prisma Bindings"
    href="#"
    description="Learn how to build a GraphQL server that uses Prisma as its data access layer." />
</Overview>
