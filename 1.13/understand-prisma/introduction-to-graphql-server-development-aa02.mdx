...
export const meta = {
  ...
  position: 30,
  description: 'This page is only relevant if you are not familiar with the main concepts of GraphQL server development, such as the GraphQL schema, its root fields and resolver functions. If you already know about these, you can skip this page.'
}
