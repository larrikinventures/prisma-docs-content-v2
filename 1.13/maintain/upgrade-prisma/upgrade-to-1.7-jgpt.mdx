...
> **Note**: You can learn more about the different properties of the `docker-compose.yml` file in the reference or directly in the [Docker documentation](https://docs.docker.com/compose/compose-file/).
