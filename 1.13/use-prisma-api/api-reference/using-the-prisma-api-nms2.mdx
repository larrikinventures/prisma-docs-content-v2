...
`request` does not support passing _headers_ to the request ([yet](https://github.com/prismagraphql/graphql-request/pull/91)). Therefore, this particular example assumes your Prisma service was deployed without a service secret.
