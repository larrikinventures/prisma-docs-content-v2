...
export const meta = {
  ...
  technology: "mysql",
  technologyOrder: 1,
  articleGroup: "dbconnector",
}


<Warning>

This page is about the **MySQL** database connector. Use the _technology switch_ in the top-right corner of this page to select a different database.
