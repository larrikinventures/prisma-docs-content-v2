...
Here are some recommended resources for you to explore next:

- [**Understand Prisma**](/1.13/understand-prisma): Learn everything you need to know about Prisma.
- [**Using the Prisma API**](nms2): Learn how to use the Prisma via HTTP and other tools.
- [**Prisma Docker setup**](rty1): Learn how to configure a Prisma server with Docker. 