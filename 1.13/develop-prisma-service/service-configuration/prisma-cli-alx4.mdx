...
Most of the commands explained in this section will be performing requests against the [Management API](foe1) of your [Prisma server](/1.13/operate-server).

Here is an overview of the available commands for managing your Prisma services:
...
## Command Reference: Data Worfklows

The commands in this section are useful for various data workflows all around your Prisma services:
...
## Command Reference: Prisma Cloud
