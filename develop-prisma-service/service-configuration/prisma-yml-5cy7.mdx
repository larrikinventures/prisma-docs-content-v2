...
The most common properties in prisma.yml are:
...
> **Note**: You can only use variables in property **values** - not in property keys. So you can't use variables to e.g. generate dynamic logical IDs in the custom resources section for example.
