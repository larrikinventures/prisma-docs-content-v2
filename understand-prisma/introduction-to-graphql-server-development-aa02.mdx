...
> This page is only relevant if you have never built a GraphQL server before and are not yet familiar with the concepts of a GraphQL schema, its root fields and resolver functions. If you already know about these, you can skip this page.

> The content on this page provides generic information around GraphQL server development and is not specific to Prisma.

## Every GraphQL API has a GraphQL schema
...
## Resolver functions implement the schema definition
...
## Query resolution and resolver execution levels
