...
- [**Introduction to GraphQL Server Development**](aa02): Learn how GraphQL servers are built. (_This page is only relevant for you if you have no experience with GraphQL servers yet and are not familiar with GraphQL schemas, resolver functions, root types and root fields, there is no Prisma-specific content_.) 
